...
const config = {
    ...
    resolve: {
        /*alias: {
         Utils: path.resolve(__dirname, '../src/server.js'),
         },*/
                ...
                benchmark: function (name) {
                    ...
                    return {
                        stop: function () {
                            ...
                            console.log('%c Benchmark:::=> ', 'color: cyan; font-weight: bold;font-size:10px');
            ...
            benchmark: function (name) {
                ...
                return {
                    stop: function () {
                        var end = new Date();
                        var time = end.getTime() - start.getTime();
                        console.log('\x1b[36m%s\x1b[0m', 'Benchmark ::: ===>> ', name, 'finished in', time, 'ms');
                    }
                }
            },
